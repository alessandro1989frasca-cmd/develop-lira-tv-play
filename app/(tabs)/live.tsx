            ...
            {todaySchedule.length === 0 ? (
              ...
              <FlatList
                ...
                getItemLayout={(_data, index) => ({
                  length: dimensions.width * 0.9 / 3,
                  offset: (dimensions.width * 0.9 / 3) * index,
                  index,
                })}
                renderItem={({ item }) => (
                  <ScheduleItem
          ...
          {currentProgram && (
            <View style={styles.infoSection}>
              ...
              <Text style={styles.infoTime}>
                {currentProgram.startTime.toLocaleTimeString('it-IT', { hour: '2-digit', minute: '2-digit', timeZone: 'Europe/Rome' })}
                {' - '}
                {currentProgram.endTime.toLocaleTimeString('it-IT', { hour: '2-digit', minute: '2-digit', timeZone: 'Europe/Rome' })}
              </Text>
            </View>
          )}
        </ScrollView>
      ...
      <View style={[
        ...
        <View style={styles.scheduleItemTop}>
          <Text style={[styles.scheduleTime, isPast && styles.schedulePast]} numberOfLines={1}>
            {program.startTime.toLocaleTimeString('it-IT', { hour: '2-digit', minute: '2-digit', timeZone: 'Europe/Rome' })}
          </Text>
          {hasNotification && (
