...
function NewsVideoPlayer({ player, isPlaying, started, onStarted, thumbnail, isFullscreen, onFullscreenChange, containerStyle }: NewsVideoPlayerProps) {
  ...
  /* Quando isPlaying cambia: nasconde o mostra i controlli */
  useEffect(() => {
...
function ArticleModal({ article, onClose }: ArticleModalProps) {
  ...
  /* Stessa logica di live.tsx: stato cambia subito, orientamento in useEffect */
  ...
  const videoContainerStyle: StyleProp<ViewStyle> = isVideoFullscreen
